...
function resetAll(){
		...
		if(poeni1==3){
			...
			document.getElementById('win1').innerHTML="Pobedio je Prvi igra"+String.fromCharCode(269);
			sakrivanje();
			par1+=1;
		}
		...
		if(poeni2==3){
			...
			document.getElementById('win1').innerHTML="Pobedio je Drugi igra"+String.fromCharCode(269);
			sakrivanje();
			par2+=1;
		}
...
function gas_muz(){
	...
	if(document.getElementById('ugasi1').muted == false){
		
		document.getElementById('ugasi1').muted = true;
...
function pali_muz(){
	...
	if(document.getElementById('ugasi1').muted == true){
		
		document.getElementById('ugasi1').muted = false;
